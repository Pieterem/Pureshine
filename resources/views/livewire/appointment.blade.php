...
<div class="body-wrapper">
 ...
 <style>
    ...
    <!-- Hier voeg je de code toe om de modal weer te geven -->
    <div class="modal fade show" tabindex="-1" role="dialog" style="display: block;">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Afspraak succesvol gemaakt!</h5>
    ...
    {{-- Voeg de Livewire methode toe om de modal te sluiten --}}
    @livewireScripts
    <script>
        Livewire.on('closeModal', function () {
            // Zet de variabele op false om te voorkomen dat de modal opnieuw wordt getoond
            @this.set('isAppointmentSuccess', false);
        });
    </script>
@endif
                                ...
                                <div class="ltn__service-item-2 white-bg" style="border: 1px solid black;">
                                    <div class="service-item-brief">
                                        ...
                                        <ul>
                                            ...
                                            <li><i class="fa-solid fa-times" style="color: red;"></i> Stoomreinigen Ventilatieroosters</li>
                                ...
                                <div class="ltn__service-item-2 white-bg" style="border: 1px solid black;">
                                    <div class="service-item-brief">
                                        ...
                                        <ul>
                                            ...
                                            <li><i class="fa-solid fa-check" style="color: lightgreen;"></i> Binnenramen reinigen</li>
                                            <li><i class="fa-solid fa-check" style="color: lightgreen;"></i> Kofferbak reinigen</li>
                                            <li><i class="fa-solid fa-check" style="color: lightgreen;"></i> Stoomreinigen Ventilatieroosters</li>
...
<div class="input-item input-item-textarea">
    <div class="ltn__service-list-menu text-uppercase mt-50">
            ...
            <div style="margin-top: 3%; display: flex; justify-content: space-between;">
                <div>
                    <a type="button" wire:click="prevStep" class="btn btn-secondary mr-2 rounded">Vorige</a>
                </div>
                <div style="text-align: right;">
                    <a type="button" wire:click="nextStep" class="btn btn-primary rounded">Volgende</a>
                </div>
            </div>
        @elseif ($currentStep == 3)
            <div style="margin-top: 3%; display: flex; justify-content: space-between;">
                ...
                <div style="text-align: right;">
                    <button wire:click.prevent="submitForm" class="btn theme-btn-1 btn-effect-1 text-uppercase rounded" type="submit">Submit Now</button>
                </div>
            </div>
        @endif
